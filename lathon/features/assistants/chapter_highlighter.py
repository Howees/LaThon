...
class ChapterHighlighter:
    ...
    def __init__(self, editor):
        ...
        # Ele mesmo escuta o editor! Inversão de controle!
    ...
    def _on_editor_changed(self, event=None):
        ...
        self.highlight_timer = self.editor.after(850, self.apply)  # Roda logo após a sintaxe base
    ...
    def apply(self):
        ...
        for match in re.finditer(r'\\(part|chapter|section|subsection|subsubsection)(\*?)\s*\{', text_content,
            ...
            tag_map = {"part": "h_part", "chapter": "h_chapter", "section": "h_section", "subsection": "h_subsection",
                       "subsubsection": "h_subsubsection"}
