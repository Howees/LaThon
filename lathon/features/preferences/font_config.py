...
class FontConfigDialog(BaseModal):
    def __init__(self, master_app):
        # Aumentamos a altura para 450 para garantir espaço de sobra em qualquer monitor
        ...
        # ==========================================
        # 1. BOTÕES E SLIDER (Ancorados no fundo PRIMEIRO)
        # Assim é impossível eles serem esmagados pela lista
        # ==========================================
        ...
        ctk.CTkLabel(self.border_frame, text="Tamanho:", font=Fonts.UI_BOLD).pack(side="bottom", anchor="w", padx=30,
                                                                                  pady=(10, 0))

        # ==========================================
        # 2. LISTA DE FONTES (Preenche o espaço restante no meio)
        # ==========================================
        ...
        # expand=True faz a lista crescer e empurrar o layout, mas parando antes do slider
    ...
    def _apply(self):
        ...
        # Chama a função no novo Manager
