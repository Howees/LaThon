...
class FontConfigDialog(BaseModal):
    def __init__(self, master_app):
        ...
        ctk.CTkLabel(self.border_frame, text="Tipo de Fonte:", font=Fonts.UI_BOLD).pack(anchor="w", padx=30, pady=(20, 0))
        ...
        ctk.CTkLabel(self.border_frame, text="Tamanho:", font=Fonts.UI_BOLD).pack(anchor="w", padx=30, pady=(10, 0))
