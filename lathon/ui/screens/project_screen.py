...
class ProjectPanel(ctk.CTkFrame):
    def __init__(self, parent, app, ws_path, manager):
        ...
        ctk.CTkLabel(logo_container, text=" v2.0", font=Fonts.UI_BOLD, text_color=Colors.TEXT_MUTED).pack(side="left", padx=(2, 0))
    ...
    def _create_card(self, parent, project_path):
        ...
        # MÁGICA: Fita Verde "flutuante" na lateral esquerda. Não afeta o tamanho do card!
